...
@ConfigurationProperties("dwp.meeting.recording.deletion")
public class MeetingRecordingDeletionProperties {

    private boolean enabled;
    private int batchSize = 50;
    private Duration pollDelay = Duration.ofMinutes(5);
    private Duration leaseDuration = Duration.ofMinutes(1);
    private String workerId = "meeting-recording-retention";
