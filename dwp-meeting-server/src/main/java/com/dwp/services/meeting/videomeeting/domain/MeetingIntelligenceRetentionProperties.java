...
@ConfigurationProperties("dwp.meeting.intelligence.retention")
public class MeetingIntelligenceRetentionProperties {

    private boolean enabled;
    private int batchSize = 100;
    private Duration pollDelay = Duration.ofMinutes(5);
    private Duration leaseDuration = Duration.ofMinutes(1);
    private String workerId = "meeting-retention-worker";
