...
@ConfigurationProperties("dwp.meeting.schedule-draft-retention")
public class MeetingScheduleDraftRetentionProperties {

    private boolean enabled = true;
    private int batchSize = 100;
    private Duration pollDelay = Duration.ofMinutes(5);
    private Duration leaseDuration = Duration.ofMinutes(1);
    private String workerId = "meeting-schedule-draft-retention";
