...
class MessagingHomeProviderExactPathSecurityTest {

    private final MessagingSecurityFilter filter =
            new MessagingSecurityFilter("gateway-purpose-token", new ObjectMapper());
