...
import static com.dwp.services.approval.informationreplay.InformationReplayProtocol.BODY_MAX;
...
/** The limit is enforced before allocating each response buffer, including chunked responses. */
final class InformationReplayResponseBody implements HttpResponse.BodySubscriber<byte[]> {
