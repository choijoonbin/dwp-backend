...
public class HomeReadModelService {
    ...
    private static final Set<String> MODES = Set.of("CLASSIC", "FLOW_V1", "MZ_V1");
    ...
    private final HomePreferenceRepository preferences;
    ...
    public HomeReadModelService(
            ...
            HomePreferenceRepository preferences) {
    ...
    private HomeReadModelDtos.ReadResult readResolved(
        ...
        String mode = effectiveMode(context, experience, requestedMode);
    ...
    private String effectiveMode(
        ...
        Set<String> allowed = experience.compositionPolicy() == null
                || experience.compositionPolicy().allowedModes() == null
                ? Set.of(effective)
