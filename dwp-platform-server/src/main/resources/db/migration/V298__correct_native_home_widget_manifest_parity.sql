-- Forward-only canonical correction for three native Home manifests seeded by V295.
...
-- This migration accepts only the exact V295 pre-state or the exact V298 final state. Any
