...
VALUES
    ('core.approvals', 'Enterprise approvals', 'APP',
     'Governed approval requests, decisions, delegation, process design, and operations')
...
SELECT plan.service_plan_id, entitlement.entitlement_id
 ...
 WHERE entitlement.entitlement_key = 'core.approvals'
