-- The Widget Registry tenant surface is governed separately from home templates.
-- Browser sessions receive only this resource family through Auth /auth/me projection.
...
VALUES (
    'ADMIN.HOME_WIDGET_POLICY', 'ADMIN', 'Home widget policy', 'core.workspace')
...
VALUES
    ('TENANT_ADMIN', 'ADMIN.HOME_WIDGET_POLICY', 'VIEW', 'ACTIVE'),
    ('TENANT_ADMIN', 'ADMIN.HOME_WIDGET_POLICY', 'MANAGE', 'ACTIVE'),
    ('TENANT_ADMIN', 'ADMIN.HOME_WIDGET_POLICY', 'PUBLISH', 'ACTIVE'),
    ('TENANT_ADMIN', 'ADMIN.HOME_WIDGET_POLICY', 'EXPLAIN', 'ACTIVE'),
    ('TENANT_ADMIN', 'ADMIN.HOME_WIDGET_POLICY', 'AUDIT', 'ACTIVE')
...
SELECT tenant.tenant_id, template.resource_type, template.resource_key,
 ...
 WHERE template.resource_key = 'ADMIN.HOME_WIDGET_POLICY'
...
-- Rotate every affected durable authority projection after adding the resource family.
