-- Catalog registration only. Published form VIEW requires an independent explicit grant.
INSERT INTO sys_tenant_resource_templates (
    resource_key, resource_type, display_name, required_entitlement)
VALUES ('ACTION.APPROVAL_FORM', 'ACTION',
        'Approval published form reference', 'core.approvals')
...
SELECT tenant.tenant_id, template.resource_type, template.resource_key,
 ...
 WHERE template.resource_key = 'ACTION.APPROVAL_FORM'
