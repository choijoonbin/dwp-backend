...
VALUES
  (1, '1000', '1900000001', '2024', 'SAP', '2024-01-15', 'KRW', 'INV-001', now(), now()),
  (1, '1000', '1900000002', '2024', 'SAP', '2024-01-16', 'KRW', 'INV-002', now(), now()),
  (1, '1000', '1900000003', '2024', 'SAP', '2024-01-17', 'KRW', 'INV-003', now(), now()),
  (1, '1000', '1900000004', '2024', 'SAP', '2024-01-18', 'KRW', 'INV-004', now(), now()),
  (1, '1000', '1900000005', '2024', 'SAP', '2024-01-19', 'KRW', 'INV-005', now(), now())
...
VALUES
  (1, '1000', '1900000001', '2024', '001', 'AP'::dwp_aura.open_item_type, 'V001', '2024-02-15', 1000000, 'KRW', false, now()),
  (1, '1000', '1900000002', '2024', '001', 'AP'::dwp_aura.open_item_type, 'V001', '2024-02-16', 500000, 'KRW', false, now()),
  (1, '1000', '1900000003', '2024', '001', 'AR'::dwp_aura.open_item_type, 'C001', '2024-02-17', 750000, 'KRW', false, now()),
  (1, '1000', '1900000004', '2024', '001', 'AP'::dwp_aura.open_item_type, 'V002', '2024-02-18', 2000000, 'KRW', false, now()),
  (1, '1000', '1900000005', '2024', '001', 'AR'::dwp_aura.open_item_type, 'C001', '2024-02-19', 300000, 'KRW', false, now())
ON CONFLICT (tenant_id, bukrs, belnr, gjahr, buzei) DO NOTHING;
...
INSERT INTO dwp_aura.agent_case (tenant_id, detected_at, bukrs, belnr, gjahr, buzei, case_type, severity, status)
SELECT 1, now(), '1000', '1900000002', '2024', '001', 'ANOMALY_AMOUNT', 'MEDIUM', 'IN_PROGRESS'
WHERE NOT EXISTS (SELECT 1 FROM dwp_aura.agent_case WHERE tenant_id=1 AND bukrs='1000' AND belnr='1900000002');
INSERT INTO dwp_aura.agent_case (tenant_id, detected_at, bukrs, belnr, gjahr, buzei, case_type, severity, status)
SELECT 1, now(), '1000', '1900000003', '2024', '001', 'MISSING_EVIDENCE', 'LOW', 'OPEN'
