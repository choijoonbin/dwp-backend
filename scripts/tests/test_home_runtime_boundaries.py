...
class HomeRuntimeBoundaryTest(unittest.TestCase):
    ...
    def test_allows_only_the_exact_platform_owned_home_command_receipt_store(self) -> None:
        self.write_runtime(
            "HomeOwnerActionReceipt.java",
            """package com.dwp.services.platform.home.runtime;
               import jakarta.persistence.Entity;
               @Entity final class HomeOwnerActionReceipt {}
            """,
        )
        self.write_runtime(
            ...
            """package com.dwp.services.platform.home.runtime;
               ...
               interface HomeOwnerActionReceiptRepository extends JpaRepository<Object, Object> {}
            """,
        )
        ...
        self.write_runtime(
            "UnexpectedRuntimeRepository.java",
            """package com.dwp.services.platform.home.runtime;
               import org.springframework.data.jpa.repository.JpaRepository;
               interface UnexpectedRuntimeRepository extends JpaRepository<Object, Object> {}
            """,
        )
        self.assertIn(
            "UnexpectedRuntimeRepository.java imports persistence APIs",
            "\n".join(CHECKER_MODULE.violations(self.root)),
        )
